 ...
 *
 * Algoritmo para converter strings em SHA1. Muito utilizado em criptografia de
 * senhas
 */
...
public class ConverterSHA1 implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        return value.isEmpty() ? "" : cipher(value);//Se o valor for vazio retorna "", senão converte
    }
